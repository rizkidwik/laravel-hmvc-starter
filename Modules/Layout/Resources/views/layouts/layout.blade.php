...
<html lang="en" class="light-style layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default"
    {{-- data-assets-path="{{ asset('custom/assets/" --}} data-template="vertical-menu-template-free">
...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('custom/assets/img/favicon/favicon.ico') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('custom/assets/vendor/css/theme-default.css') }}"
        class="template-customizer-theme-css" />
    <link rel="stylesheet" href="{{ asset('custom/assets/css/demo.css') }}" />
    ...
    <!-- Helpers -->
    <script src="{{ asset('custom/assets/vendor/js/helpers.js') }}"></script>
    <!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
    <!--? Config:  Mandatory theme config file contain global vars & default theme options, Set your preferred theme option in this file.  -->
    <script src="{{ asset('custom/assets/js/config.js') }}"></script>
</head>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="{{ asset('custom/assets/img/avatars/1.png') }}" alt
